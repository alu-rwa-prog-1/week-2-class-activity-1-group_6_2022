...
class Appcolor{
  static Color homePageBackground=const Color(0xFF21212F);
  static Color gradientFirst=const Color(0xff0f17ad);
  static Color gradientSecond=const Color(0xFF6985e8);
  static Color homePageTitle=const Color(0xff9999a9);
  ...
  static Color SecondPageContainerGradient1stColor=const Color(0xFF3b3c5c);
